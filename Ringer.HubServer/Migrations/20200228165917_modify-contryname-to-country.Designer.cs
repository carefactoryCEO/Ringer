...
namespace Ringer.HubServer.Migrations
{
    ...
    [Migration("20200228165917_modify-contryname-to-country")]
    partial class modifycontrynametocountry
    {
            ...
            modelBuilder.Entity("Ringer.Core.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2020, 2, 28, 16, 59, 17, 148, DateTimeKind.Utc).AddTicks(3200),
                            Gender = "Male",
                            Name = "Admin",
                        ...
                        new
                        {
                            Id = 2,
                            BirthDate = new DateTime(1976, 7, 21, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedAt = new DateTime(2020, 2, 28, 16, 59, 17, 148, DateTimeKind.Utc).AddTicks(3980),
                            Gender = "Male",
                            Name = "신모범",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserType = "Consumer"
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2020, 2, 28, 16, 59, 17, 148, DateTimeKind.Utc).AddTicks(3990),
                            Gender = "Female",
                            Name = "김은미",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserType = "Consumer"
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2020, 2, 28, 16, 59, 17, 148, DateTimeKind.Utc).AddTicks(4000),
                            Gender = "Male",
                            Name = "김순용",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserType = "Consumer"
