...
namespace Ringer.HubServer.Migrations
{
    ...
    [Migration("20200424061440_Make-RoomId-Required-To-Message-And-Enrollment")]
    partial class MakeRoomIdRequiredToMessageAndEnrollment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ringer.Core.Models.Agreement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Ringer.Core.Models.Consulate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Ringer.Core.Models.FootPrint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Ringer.Core.Models.Terms", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Ringer.Core.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2020, 4, 24, 6, 14, 39, 909, DateTimeKind.Utc).AddTicks(6240),
                            Gender = "Male",
                            Name = "Admin",
                        ...
                        new
                        {
                            Id = 2,
                            BirthDate = new DateTime(1976, 7, 21, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedAt = new DateTime(2020, 4, 24, 6, 14, 39, 909, DateTimeKind.Utc).AddTicks(6980),
                            Gender = "Male",
                            Name = "신모범",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserType = "Consumer"
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2020, 4, 24, 6, 14, 39, 909, DateTimeKind.Utc).AddTicks(7000),
                            Gender = "Female",
                            Name = "김은미",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserType = "Consumer"
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2020, 4, 24, 6, 14, 39, 909, DateTimeKind.Utc).AddTicks(7010),
                            Gender = "Female",
                            Name = "함주희",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserType = "Consumer"
            ...
            modelBuilder.Entity("Ringer.Core.Models.Agreement", b =>
                {
                    b.HasOne("Ringer.Core.Models.Terms", "Terms")
                        .WithMany("Agreements")
