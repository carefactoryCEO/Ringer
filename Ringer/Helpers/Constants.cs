...
namespace Ringer.Helpers
{
    public static class Constants
    {
        ...
        public static readonly string HubUrl = "http://localhost:5000/hubs/chat";
        //public static readonly string HubUrl = "https://ringerhub.azurewebsites.net/hubs/chat";
        public static readonly string TokenUrl = "http://localhost:5000/auth/login";
        //public static readonly string TokenUrl = "https://ringerhub.azurewebsites.net/auth/login";
