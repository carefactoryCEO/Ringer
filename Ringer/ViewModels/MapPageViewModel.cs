...
namespace Ringer.ViewModels
{
    public class MapPageViewModel : INotifyPropertyChanged
    {
        ...
        public MapPageViewModel()
        {
            ...
            SendEmailCommand = new Command<Consulate>(async consulate => await SendEmail(consulate));
            OpenSiteCommand = new Command<Consulate>(async consulate => await OpenSite(consulate));
            PhoneCallCommand = new Command<string>(number => PhoneCall(number));
            OpenMapCommand = new Command<Consulate>(async consulate => await OpenMap(consulate));
        }
