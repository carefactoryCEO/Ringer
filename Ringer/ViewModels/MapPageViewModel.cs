...
namespace Ringer.ViewModels
{
    public class MapPageViewModel : INotifyPropertyChanged
    {
        ...
        public ObservableCollection<Consulate> Consulates { get; set; } = new ObservableCollection<Consulate>();
        ...
        public MapPageViewModel()
        {
            ...
            /**
            //dummy for UI design
            //Consulates = new ObservableCollection<Consulate>
            //{
            //    new Consulate
            //    {
            //        Id = 91,
            ...
            //        EmergencyPhoneNumber = "+1-907-331-7135", Email = "anchorage@mofa.go.kr",
            ...
            //    {
            //        Distance = 114.5,
            //        Id = 115, ConsulateType = "총영사관", KoreanName = "주 뉴욕 대한민국 총영사관", LocalName = "Consulate General of the Republic of Korea in New York", PhoneNumber = "+1-646-674-6000",
            //        EmergencyPhoneNumber = "+1-646-965-3639", Email = "kcg_ny@mofa.go.kr", Address = "460 Park Ave.(bet.57th & 58th St.) New York, NY 10022", Homepage = "http://overseas.mofa.go.kr/us-newyork-ko/index.do,40.76227,-73.970984", GoogleMap = "https://www.google.com/maps/place/%EC%A3%BC+%EB%89%B4%EC%9A%95+%EB%8C%80%ED%95%9C%EB%AF%BC%EA%B5%AD+%EC%B4%9D%EC%98%81%EC%82%AC%EA%B4%80/@40.7620224,-73.971005,17z/data=!3m1!4b1!4m5!3m4!1s0x89c258e53588393f:0x995641481cd802c8!8m2!3d40.7620224!4d-73.971005?hl=ko",
            ...
            //    {
            //        Distance = 160.8,
            //        Id = 116, ConsulateType = "총영사관", KoreanName = "주 애틀랜타 대한민국 총영사관", LocalName = "Consulate General of the Republic of Korea in Atlanta",
            //        PhoneNumber = "+404-522-1611", EmergencyPhoneNumber="+404-295-2807", Email="atlanta@mofa.go.kr",Address="229 Peachtree Street NE, Suite 2100, International Tower, Atlanta, GA 30303",
            ...
            //    {
            //        Distance = 2078.5,
            //        Id = 117, ConsulateType = "총영사관",KoreanName="주 시카고 대한민국 총영사관", LocalName = "Consulate General of the Republic of Korea in Chicago",
            //        PhoneNumber="+312-822-9485",EmergencyPhoneNumber="+312-405-4425", Email="chicago@mofa.go.kr", Address="Korean Consulate General NBC Tower Suite 2700, 455 N. Cityfront Plaza Dr. Chicago, IL 60611",
            //        Homepage = "https://overseas.mofa.go.kr/us-chicago-ko/index.do,41.890154,-87.621363,", GoogleMap="https://www.google.com/maps/place/%EC%A3%BC+%EC%8B%9C%EC%B9%B4%EA%B3%A0+%EB%8C%80%ED%95%9C%EB%AF%BC%EA%B5%AD+%EC%B4%9D%EC%98%81%EC%82%AC%EA%B4%80/@41.8899579,-87.6213417,17z/data=!3m1!4b1!4m5!3m4!1s0x880e2ca97c123f17:0x2b6a7fddc2b2de6!8m2!3d41.8899579!4d-87.6213417?hl=ko",
            //        Latitude = 41.890154,
            //        Longitude = -87.621363,
            //    }
            ...
            */
            ...
            SendEmailCommand = new Command<Consulate>(consulate => SendEmail(consulate));
            OpenSiteCommand = new Command<Consulate>(consulate => OpenSite(consulate));
            PhoneCallCommand = new Command<string>(number => PhoneCall(number));
            OpenMapCommand = new Command<Consulate>(consulate => OpenMap(consulate));
        }

        private void OpenMap(Consulate consulate)
        {
            var location = new Location(consulate.Latitude, consulate.Longitude);
            var options = new MapLaunchOptions
            {
                Name = consulate.KoreanName
            };
        ...
        private void SetConsulates()
        {
            ...
            foreach (var consulate in location.Consulates.Take(15))
            {
        ...
        private void OpenSite(Consulate consulate)
        {
            Browser.OpenAsync(consulate.Homepage, new BrowserLaunchOptions
            {
        ...
        private async void SendEmail(Consulate consulate)
        {
            try
            {
